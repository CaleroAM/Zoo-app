<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_food" class="form-control @error('id_food') is-invalid @enderror" value="{{ old('id_food', $food?->id_food) }}" id="id_food" placeholder="Id Food">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="total_amount" class="form-control @error('total_amount') is-invalid @enderror" value="{{ old('total_amount', $food?->total_amount) }}" id="total_amount" placeholder="Total Amount">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="cost" class="form-control @error('cost') is-invalid @enderror" value="{{ old('cost', $food?->cost) }}" id="cost" placeholder="Cost">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fk_supplier" class="form-control @error('fk_supplier') is-invalid @enderror" value="{{ old('fk_supplier', $food?->fk_supplier) }}" id="fk_supplier" placeholder="Fk Supplier">
